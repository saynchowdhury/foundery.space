          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1 group">
              ...
              <input
                ...
                className="w-full bg-white/[0.02] border border-white/5 h-12 pl-16 pr-16 font-mono-technical text-xs tracking-wider focus:outline-none focus:border-brand/40 focus:bg-white/[0.04] transition-all uppercase"
              />
              {q && (
                <button
                  type="button"
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-1 text-white/20 hover:text-brand transition-all group/clear z-10"
                >
                  <span className="font-mono-technical text-xs">[</span>
